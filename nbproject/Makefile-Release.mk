...
${OBJECTDIR}/src/bsdiff/bsdiff.o: src/bsdiff/bsdiff.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bsdiff/bsdiff.o src/bsdiff/bsdiff.c

${OBJECTDIR}/src/bsdiff/bspatch.o: src/bsdiff/bspatch.c
	${MKDIR} -p ${OBJECTDIR}/src/bsdiff
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bsdiff/bspatch.o src/bsdiff/bspatch.c
...
${OBJECTDIR}/src/mkpatch.o: src/mkpatch.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mkpatch.o src/mkpatch.c
